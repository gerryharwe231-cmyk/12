...
public final class ModelTemplateArcRenderer {
    ...
    private static TemplateHandle handle(ArcRibbonBlockEntity entity) {
        ...
        if (cached != null && cachedRevision != null && cachedRevision == entity.getRenderRevision()) return cached;
        ...
        TemplateHandle built = new TemplateHandle(Map.copyOf(revisions), Map.copyOf(frozen));
    ...
    private record TemplateHandle(Map<BlockPos, Integer> memberRevisions,
                                  Map<BlockPos, List<Strip>> byOwner) {}
}
