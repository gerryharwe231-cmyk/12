...
assert 'CURVED_SOURCE_SLICE = 1.0 / 16.0' in renderer
assert 'STRAIGHT_SOURCE_SLICE = 1.0 / 4.0' in renderer
assert 'curve.isNearStraight(moduleStart, moduleLength)' in renderer
